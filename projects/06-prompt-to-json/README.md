...
1. Deberás configurar tu chatflow de manera que tome el input del usuario y sea utilizado como parte de la cadena de prompts.
...
- [Introducción a Ingenieria de Promptind](https://learnprompting.org/es/docs/basics/prompting)
